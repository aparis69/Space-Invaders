...
public:
    ...
    inline void moveX(int mv)
    {
        x += mv;
    }

    inline void moveY(int my)
    {
        y += my;
    }

    inline void setPosition(int inx, int iny)
    {
        x = inx;
        y = iny;
    }
    ...
    inline int getVx() const
    {
        return vx;
    }

    inline int getVy() const
    {
        return vy;
    }
